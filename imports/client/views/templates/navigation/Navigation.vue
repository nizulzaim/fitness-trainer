    ...
    <scroll-bar class="flex-fill-height">
        <div>
            ...
            <nav-list class="nav-item" :sublist="true" v-if="loginUser && loginUser.isNormal()">
                <icon name="food-fork-drink"></icon> Glucose Level
                <span slot="sublist">
            ...
            <nav-list class="nav-item" :sublist="true" v-if="loginUser && loginUser.isNormal()">
                <icon name="weight-kilogram"></icon> Weight Lost
                <span slot="sublist">
                    ...
                    <router-link to="/dashboard/diet-plan" exact>
                        <nav-list class="nav-item">
                            <icon name="food-off"></icon> Diet Plan
                        </nav-list>
                    </router-link>
                </span>
            </nav-list>
            <nav-list class="nav-item" :sublist="true" v-if="loginUser && loginUser.isNormal()">
                <icon name="heart-pulse"></icon> Heart Disease
                <span slot="sublist">
                    <router-link to="/dashboard/hd-info" exact>
                        <nav-list  class="nav-item">
                            <icon name="information"></icon> Info
                        </nav-list>
                    </router-link>
                    <router-link to="/dashboard/hd-history" exact>
                        <nav-list class="nav-item">
                            <icon name="calculator"></icon> Heart Disease Diagnostic
                        </nav-list>
                    </router-link>
                </span>
            </nav-list>
